MODULE dry; (*$T- Rewrite to Modula-2 by Andy 21-Apr-88. (c) KRONOS *)
...
TYPE integer = {-8000h..7FFFh};
     OneToThirty   = integer;
     OneToFifty    = integer;
     CapitalLetter = CHAR;
     String30      = ARRAY [integer(0)..31] OF CHAR;
     Array1Dim     = ARRAY [integer(0)..51] OF integer;
     Array2Dim     = ARRAY [integer(0)..51],[integer(0)..51] OF integer;
...
BEGIN
--write_string('proc 3'15c 12c);
        IF PtrGlob # NULL THEN
