...
BEGIN
  IF cmd.siz[cmd.stk-1]=4 THEN
    cmd.save; eml.emul_call(pos,'cmul4');
  ELSE
    cmd.pop_reg(2);
    IF cmd.siz[cmd.stk-1]=2 THEN
...
BEGIN
  IF cmd.siz[cmd.stk-1]=4 THEN
    cmd.save; eml.emul_call(pos,'iquot4');
  ELSE
    cmd.pop_reg(2);
...
BEGIN
  IF cmd.siz[cmd.stk-1]=4 THEN
    cmd.save; eml.emul_call(pos,'cdiv4');
  ELSE
    cmd.pop_reg(2);
    IF cmd.pos[cmd.stk-1]=cmd.da THEN put.b(put.xchg_cx) END;
    IF cmd.siz[cmd.stk-1]=2 THEN
...
BEGIN
  IF cmd.siz[cmd.stk-1]=4 THEN
    cmd.save; eml.emul_call(pos,'irem4');
  ELSE
    cmd.pop_reg(2);
    IF cmd.pos[cmd.stk-1]=cmd.da THEN put.b(put.xchg_cx) END;
    IF cmd.siz[cmd.stk-1]=2 THEN
...
BEGIN
  ...
  ELSE
    ...
    CASE cmd.siz[cmd.stk-1] OF
      |1: eml.emul_call(pos,'imod1');
      |2: eml.emul_call(pos,'imod2');
      |4: eml.emul_call(pos,'imod4');
    END;
...
BEGIN
  IF cmd.siz[cmd.stk-1]=4 THEN
    cmd.save; eml.emul_call(pos,'cmod4');
  ELSE
    cmd.pop_reg(2);
    IF cmd.pos[cmd.stk-1]=cmd.da THEN put.b(put.xchg_cx) END;
    IF cmd.siz[cmd.stk-1]=2 THEN
