MODULE TT2VT52; (* Leo 22-Oct-89. (c) KRONOS *)  IMPORT  SYSTEM;
...
BEGIN
  ...
  WITH tstate DO
    CASE no OF
      ...
      |dtt._up           : str:="" 33c 'A'; len:=2;
      |dtt._down         : str:="" 33c 'B'; len:=2;
      |dtt._right        : str:="" 33c 'C'; len:=2;
      |dtt._left         : str:="" 33c 'D'; len:=2;
      |dtt._home         : str:="" 33c "H"; len:=2

      |dtt._bottom       : str:="" 33c 'Y 7'; len:=4;
...
--    |dtt._erase_chars  : str:="" 233c; len:=1; app1("X")
      |dtt._set_pos      : str:="" 33c 'Y  ';
                           str[2]:=CHAR(i0+ORD(' '));
                           str[3]:=CHAR(i1+ORD(' '));
                           len:=4;
      |dtt._roll_up      : str:="" 33c 'Y7 ' 12c;   len:=5;
      |dtt._roll_down    : str:="" 33c 'H' 33c 'I'; len:=4;
