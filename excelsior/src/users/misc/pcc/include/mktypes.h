...
#define	EXTVAR	500	/* external variables		*/
#define	EXTFUN	500	/* external functions		*/
...
#define	OBJ2_VERSION	0x4321		/* object file version for 2   */
#define OBJ25_VERSION   0x5432		/* object file version for 2.5 */
